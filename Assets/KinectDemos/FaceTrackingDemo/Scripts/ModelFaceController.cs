...
public class ModelFaceController : MonoBehaviour 
{
	...
	void Update() 
	{
        ...
        {
            Positions = "FACE NOT BEING TRACKED.";
        }
		else if(manager )//&& manager.IsTrackingFace())
		{
            ...
            str.Append(fAU6_right);
            Positions = str.ToString();
        }
	}
